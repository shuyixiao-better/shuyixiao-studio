...
export const affiliateProducts: AffiliateProduct[] = [
  ...
  // ========================================
  // 示例 5: 开发工具 - Qoder AI 编程助手
  // ========================================
  {
    id: 'qoder-ai-assistant',
    title: 'Qoder AI 编程助手',
    description: '智能 AI 编程工具，提升开发效率，支持多模型切换',
    longDescription: 'Qoder 是新一代 AI 编程助手，支持多种主流 AI 模型（GPT-4、Claude、Gemini 等）。提供智能代码补全、代码解释、Bug 修复、代码重构等功能。通过推荐链接注册，双方均可获得额外积分奖励，让 AI 编程更加高效便捷。',
    icon: '🚀',
    link: 'https://qoder.com/referral?referral_code=SYUjl98SBpulUDoAzCUWVR0zF4OFKIQ5',
    price: '新用户福利',
    discount: '推荐注册送积分',
    badge: '推荐有礼',
    category: '开发工具',
    tags: ['AI', '编程助手', 'Qoder', '多模型', '代码补全'],
    priority: 8,
    featured: true,
    active: true
  },
