    ...
    sidebar: {
      '/articles/MyBatis-Log-Panda': [
        {
          ...
          collapsed: false,
          items: [
            { text: 'v2025.9.8 (敬请期待)', link: '/articles/MyBatis-Log-Panda#v2025-9-8-敬请期待' },
            { text: 'v2025.9.7 (2026-01-28)', link: '/articles/MyBatis-Log-Panda#v2025-9-7-2026-01-28' },
            { text: 'v2025.9.6 (2026-01-23)', link: '/articles/MyBatis-Log-Panda#v2025-9-6-2026-01-23' },
      ...
      '/articles/gitpulse-intro': [
        {
          ...
          collapsed: false,
          items: [
            { text: 'v1.7.0 (敬请期待)', link: '/articles/gitpulse-intro#v1-7-0-敬请期待' },
            { text: 'v1.6.0 (2026-01-27)', link: '/articles/gitpulse-intro#v1-6-0-2026-01-27' },
            { text: 'v1.5.0 (2026-01-26)', link: '/articles/gitpulse-intro#v1-5-0-2026-01-26' },
      ...
      '/articles/panda-coder-intro': [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: 'v2.4.8 (敬请期待)', link: '/articles/panda-coder-intro#v2-4-8-敬请期待' },
          ...
          items: [
            {
              ...
              items: [
                ...
                { text: 'IDEA 调试技巧：关联本地源码，告别反编译代码', link: '/tutorials/insights/growth/IDEA 调试技巧：关联本地源码，告别反编译代码' },
              ]
            },
            {
              text: '职场人生思考',
              ...
              items: [
                ...
                { text: '罗振宇2025跨年演讲：在显白教诲之下，我们错过了哪些隐微真相', link: '/tutorials/insights/career/罗振宇2025跨年演讲：在显白教诲之下，我们错过了哪些隐微真相' },
