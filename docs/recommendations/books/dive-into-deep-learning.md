---
title: 动手学深度学习
description: 阿斯顿·张、李沐等著 - 理论与实践结合的深度学习教材
---
...
<div class="book-header">
  ...
  <div class="book-meta">
    <h2>动手学深度学习</h2>
    <p class="author">作者：阿斯顿·张、李沐、扎卡里·C·立顿、亚历山大·J·斯莫拉</p>
    <p class="rating">推荐指数：⭐⭐⭐⭐⭐</p>
    <p class="category">分类：AI与大模型 / 深度学习</p>
  </div>
</div>

## 📝 推荐理由

李沐老师的经典教材，理论与实践完美结合，配有丰富的代码示例。是入门深度学习的最佳选择。
